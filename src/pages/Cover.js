...
const Cover = () => {
  return (
    <div className={styles.cover}>
      <img className={styles.g12Icon} alt="" src="/g12.svg" />
      <div className={styles.hireKarmaDashboard}>Hire Karma Dashboard</div>
      <div className={styles.dashboard}>
        ...
        <div className={styles.component3}>
          ...
          <img className={styles.component3Item} alt="" src="/group-27.svg" />
